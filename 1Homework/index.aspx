    ...
    <form id="form1" runat="server">
        ...
        <section class="position-relative container-fluid mt-3">
            <article class="w-100 bg-success bg-opacity-50 p-3 text-light rounded-3 shadow">
                ...
                <div role="button" href="#videoCollapse" data-bs-toggle="collapse" aria-controls="videoCollapse" aria-expanded="false">
                ...
                <div runat="server" class="mt-3 collapse" id="videoCollapse">
        ...
        <section class="position-relative container-fluid mt-3">
            <article class="w-100 bg-info bg-opacity-50 p-3 text-light rounded-3 shadow">
                ...
                <div role="button" href="#gameCollapse" data-bs-toggle="collapse" aria-controls="gameCollapse" aria-expanded="false">
                ...
                <%-- Hangman display --%>
                <div runat="server" class="mt-3 collapse" id="gameCollapse">
                    ...
                    <%-- Game display hidden until the game is started --%>
